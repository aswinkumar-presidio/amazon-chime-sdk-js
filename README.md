...
The use of TensorFlow runtime code referenced above may be subject to additional license requirements. See the licenses page for TensorFlow.js (https://github.com/tensorflow/tfjs/blob/master/LICENSE) and TensorFlow.js models (https://github.com/tensorflow/tfjs-models/blob/master/LICENSE)for details.
